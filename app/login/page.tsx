...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen flex flex-col max-w-md mx-auto relative overflow-hidden bg-background font-sans text-white selection:bg-primary/30 transition-colors">
            ...
            <div className="absolute -top-40 -right-40 w-96 h-96 bg-primary/20 rounded-full blur-[150px] animate-pulse"></div>
            <div className="absolute top-1/2 -left-40 w-80 h-80 bg-blue-600/10 rounded-full blur-[120px]"></div>
            <div className="absolute -bottom-40 right-10 w-80 h-80 bg-primary/10 rounded-full blur-[120px]"></div>

            <div className="flex-1 flex flex-col px-8 pt-16 pb-8 z-10 justify-center">
                {/* Logo Section */}
                <div className="flex flex-col items-center mb-12">
                    <div className="w-24 h-24 bg-gradient-to-br from-primary/20 to-primary/5 rounded-3xl flex items-center justify-center mb-8 shadow-[0_0_50px_rgba(204,255,0,0.2)] border border-primary/30 backdrop-blur-xl relative group">
                    ...
                    <h1 className="text-5xl font-black tracking-tighter text-white uppercase text-center leading-none">
                        WIP<span className="text-primary block text-6xl mt-1 drop-shadow-[0_0_10px_rgba(204,255,0,0.5)]">QUINIELA</span>
                    </h1>
                    <p className="text-white/60 text-[10px] tracking-[0.4em] mt-4 font-bold uppercase border border-white/10 px-4 py-1.5 rounded-full bg-white/5 backdrop-blur-md">
                        Digital Experience
                    </p>
                </div>

                {/* Login Form */}
                <form onSubmit={handleSubmit} className="space-y-6 bg-white/[0.03] p-8 rounded-[2rem] border border-white/10 shadow-2xl backdrop-blur-md relative overflow-hidden">
                    {/* Glass Reflection */}
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative group focus-within:ring-2 ring-primary/50 rounded-2xl border border-white/10 bg-black/20 transition-all duration-300 hover:bg-black/30">
                            <span className="material-icons absolute left-4 top-1/2 -translate-y-1/2 text-white/30 group-focus-within:text-primary transition-colors">lock_outline</span>
                            <input
                                type="password"
                                value={password}
                    ...
                    <button type="submit" className="w-full bg-primary hover:bg-[#d4ff00] text-black py-4 rounded-2xl font-black text-lg shadow-[0_0_30px_rgba(204,255,0,0.3)] hover:shadow-[0_0_50px_rgba(204,255,0,0.5)] active:scale-[0.98] transition-all duration-300 uppercase tracking-widest relative overflow-hidden group">
                        <span className="relative z-10 flex items-center justify-center gap-2">
                            Ingresar <span className="material-icons-round text-lg">arrow_forward</span>
                        </span>
                    ...
                    <div className="flex justify-center">
                        <a href="#" className="text-[10px] text-white/40 hover:text-primary transition-colors font-bold uppercase tracking-widest hover:underline decoration-primary/30 underline-offset-4">¿Olvidaste tu contraseña?</a>
                    </div>
                </form>
                ...
                <div className="mt-8">
                    <div className="relative flex items-center mb-6">
                        ...
                        <span className="px-4 text-[9px] uppercase tracking-widest text-white/30 font-bold">O continúa con</span>
                        <div className="flex-grow border-t border-white/5"></div>
                    </div>
                ...
                <div className="mt-auto pt-8 text-center bg-transparent">
                    <p className="text-sm text-white/40 font-medium">
                        ¿No tienes cuenta?
                        <Link href="/register" className="text-primary font-black hover:underline decoration-primary/50 underline-offset-4 ml-2 hover:text-[#eaff00] transition-colors uppercase text-xs tracking-wider">CREAR CUENTA</Link>
                    </p>
                </div>
            </div>
        </div>
