            ...
            <div className="flex-1 flex flex-col px-8 pt-12 pb-8">
                ...
                <div className="flex flex-col items-center mb-10">
                    ...
                    <h1 className="text-3xl font-bold tracking-tight text-white uppercase">
                        Crear <span className="text-[#ff6600] font-light">Cuenta</span>
                    </h1>
                    <p className="text-[#ff6600]/60 text-xs tracking-[0.2em] mt-1 font-medium">ÚNETE A QUINIELA DIGITAL</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        <label className="block text-[10px] uppercase tracking-widest text-[#ff6600] font-semibold mb-2 ml-1">Nombre Completo</label>
                        <div className="relative group focus-within:ring-1 ring-[#ff6600] rounded-xl border border-[#333333] bg-[#1a1a1a]/50 transition-all duration-300">
                            <span className="material-icons absolute left-4 top-1/2 -translate-y-1/2 text-[#333333] group-focus-within:text-[#ff6600] text-xl">person</span>
                            <input
                                type="text"
                                value={name}
                ...
                <div className="mt-8">
                    <div className="relative flex items-center mb-6">
                        ...
                        <span className="px-4 text-[10px] uppercase tracking-widest text-[#333333] font-bold">O regístrate con</span>
                        <div className="flex-grow border-t border-[#333333]/30"></div>
                    </div>
                ...
                <div className="mt-auto pt-6 text-center">
                    <p className="text-sm text-[#333333]">
                        ...
                        <Link href="/login" className="text-[#ff6600] font-bold hover:underline decoration-[#ff6600]/30 underline-offset-4 ml-1">Inicia Sesión</Link>
                    </p>
                </div>
            </div>
        </div>
